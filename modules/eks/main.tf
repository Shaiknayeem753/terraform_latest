...
resource "aws_eks_node_group" "my_node" {
  ...
  depends_on = [
    aws_iam_role_policy_attachment.my_node-AmazonEKSWorkerNodePolicy,
    aws_iam_role_policy_attachment.my_node-AmazonEKS_CNI_Policy,
    aws_iam_role_policy_attachment.my_node-AmazonEC2ContainerRegistryReadOnly,
  ]
}
...
resource "aws_iam_role" "my_role_two" {
  name = "eks-node-group-my_node"
